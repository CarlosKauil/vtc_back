      ...
      <div className="max-w-3xl mx-auto w-full flex flex-col gap-6 py-10 px-2 md:px-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center relative">
          ...
          <div className="w-full flex flex-col md:flex-row gap-4 mb-6">
            ...
            <a
              href="/assets/Manual-de-usuario.pdf"
              download
              className="flex-1 px-6 py-3 rounded-xl bg-green-600 text-white text-center shadow-md hover:bg-green-700 transition font-semibold"
            >
